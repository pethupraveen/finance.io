...
<head> 
	...
	<!-- /core JS files --> <script type="text/javascript" src="<?=site_url('assets') ?>/js/core/app.js"></script>
</head>

<body class="navbar-bottom navbar-top"> <!-- Main navbar --> 
	<div class="navbar navbar-inverse navbar-fixed-top"> 
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav"> 
				...
				<li><a href="<?=site_url('Master')?>">Master</a></li> <li><a href="<?=site_url('Principal')?>">Principal Loan</a></li>
				<li><a href="<?=site_url('Monthly_Loan')?>">Monthly Loan</a></li> 
				<li><a href="#">Tip Up Loan</a></li> <li><a href="#">Deposit</a></li> 
				<li><a href="#">Book Keeping</a></li> <li><a href="#">Report</a></li> 
				<li><a href="#">Final Report</a></li> <li><a href="#">Utility</a></li>
...
<div class="content-wrapper">
	...
	<div class="row">
		<div class="col-lg-12"> 
			<!-- 2 columns form --> 
			<form class="form-horizontal" action="<?=site_url('Monthly_Loan/Open_Payment_Add')?>" method="POST"> 
							...
							<fieldset> 
								<div class="form-group form-group-xs"> <label class="col-lg-3 control-label">Date:</label>
									...
									<script> 
										function addNum7() 
										{
											...
											var ansz = document.getElementById("AcNo2"); ansz.value =  val9 + 1;
										} 
									</script> 
								...
								<div class="col-md-6">
									<fieldset>
										...
										<div class="col-lg-4"> 
											<input type="text" class="form-control" id="interest" placeholder="Intrest Amount" name="IAmount" readonly>
										</div> 
									</div>
									<div class="form-group form-group-xs">
										<label class="col-lg-3 control-label">Adv Intrest Amount:</label> 
										<div class="col-lg-9"> 
											<input class="form-control" placeholder="Enter Advance Intrest Amount"name="AIntrest" id="Ainterest" type="number" onchange="computeLoan()"> 
...
<div class="col-lg-9"> 
<input type="text" class="form-control" id="interest" name="IAmount"> 
</div> 
</div> 
<div class="form-group form-group-xs">
