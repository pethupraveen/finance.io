...
<div class="content-wrapper">
	...
	<div class="col-lg-12">
		...
		<form class="form-horizontal" action="<?=site_url('TipUp_Loan/Payment_Print')?>" method="POST" target="_blank">
			<div class="panel panel-flat">
				<div class="panel-heading">
					
					<h6 class="panel-title">TieUp Loan <span class="text-muted">Payment Register</span></h6>
