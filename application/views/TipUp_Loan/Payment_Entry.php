...
<div class="content-wrapper">
	<form  class="form-horizontal" method="POST" action="<?=site_url('TipUp_Loan\insert')?>">
		<div class="panel panel-flat">
			<div  class="panel-heading">
				<h5 class="panel-title">TieUp Loan <span class="text-muted">Payment Entry</span></h5>
				<div class="heading-elements">
					<div class="heading-btn">
						<button type="button" id="New" class="btn btn-info btn-xs"><i class="icon-new position-left"></i>New</button>
					...
					<div class="col-md-6">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-lg-9">
									<select class="bootstrap-select" data-live-search="true" data-width="100%" name="TName" required>
										<option></option>
