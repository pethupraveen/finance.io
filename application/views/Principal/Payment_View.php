...
<div class="content-wrapper">
	...
	<div class="panel panel-flat">
		...
		<div class="panel-heading">
			<h5 class="panel-title"><small>Principal Loan</small> - Payment View </h5>
			<div class="heading-elements">
				<div class="heading-btn">
					<a class="btn btn-info" href="<?=site_url('Principal/Payment_View')?>"><i class="icon-archive position-left"></i> View All Data</a>
					<a class="btn bg-slate" href="<?=site_url('Principal/Payment_Entry')?>"><i class="icon-add position-left"></i> Add New </a>
				</div>
			</div>
		</div>
		...
		<table class="table datatable-responsive">
			...
			<tbody>
				...
				foreach($query->result() as $row)
				{
					...
					echo "</td><td>";
					$string = $row->Terms;
					if($string = 'M' || 'W' || 'D') { echo $row->Amount;}
					echo "</td><td>";
					$string = $row->Terms;
					...
					<td class="text-center">
						<ul class="icons-list">
							<li class="dropdown">
								...
								<li><a href="<?php echo site_url('Principal/Payment_Edit/'.$row->id); ?>"><i class=" icon-pencil7"></i> Edit</a></li>
								<li>
								<a href="<?php echo site_url('Principal/Payment_Delete/'.$row->id); ?>"><i class="icon-cross2"></i> Remove</a>
								</li>
