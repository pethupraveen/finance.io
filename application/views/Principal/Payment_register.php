...
<?php include 'inc/sidebar.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="panel panel-flat">
					...
					if($string = 'Monthly' || 'Weekly' || 'Daily') { echo $row->AmountM;  echo $row->AmountW; echo $row->AmountD; } ?></td>
								<td><?php $string = $row->Terms;
					if($string = 'Monthly' || 'Weekly' || 'Daily') { echo $row->Monthly;  echo $row->Weekly; echo $row->Daily; } ?></td>
							</tr>
						<?php endforeach; ?>
						</tbody>
					</table>
