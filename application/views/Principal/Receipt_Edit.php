...
<div class="content-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<form class="form-horizontal" action="<?php echo site_url('Principal/Receipt_Update/'.$query->id); ?>" method="POST">
						...
						<div class="col-md-6">
							<fieldset>
								<div class="form-group form-group-xs">
									...
									<div class="col-lg-9">
										<input type="text" id="payAmount" class="form-control" placeholder="Enter Receipt Loan Amount" name="payAmount" value="<?php echo $query->payAmount; ?>" onclick="javascript:addNum1();">
