		...
		<div id="modal_form_inline" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content text-center">
					...
					<form action="<?=site_url('Principal/Open_Payment_Edit2')?>" class="form-inline" method="POST">
		...
		<form class="form-horizontal" action="<?=site_url('Principal/Open_Payment_Entry')?>" method="POST"> 
			<div class="panel panel-flat"> 
				<div class="panel-heading">
					<h5 class="panel-title">Opening Principal Loan- <mute>Opening Payment Entry</mute></h5> 
						...
						<fieldset> 
							...
							<div class="form-group form-group-xs"> <label class="col-lg-3 control-label">Date:</label>
								...
								<div class="form-group form-group-xs"> 
									...
									<div class="col-lg-9"> 
										<input type="text" class="form-control" name="AcNo" id="AcNo" value="" required>
								...
								<div class="form-group form-group-xs">
									...
									<div class="col-lg-9"> 
										<!--<select class="bootstrap-select" data-live-search="true" data-width="100%" name="PName" required>-->
										<select class="form-control" name="PName" required="required">
											 <option value="">Select Any Party Name</option>
								...
								<div class="form-group form-group-xs">
									...
									<div class="col-lg-9">
										<input type="text" id="Monthly" class="form-control" placeholder="Enter Number of" name="Monthly" value="<?php echo set_value('Monthly')?>">
								...
								<div class="form-group form-group-xs">
									...
									<div class="col-lg-9">
										<input type="text" id="Amount" class="form-control" placeholder="Enter Amount" name="Amount" value="<?php echo set_value('Amount')?>">
