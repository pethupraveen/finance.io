				...
				<form class="form-horizontal" action="<?php echo site_url('Principal/Open_Receipt_Entry/'); ?>" method="POST">
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Open Receipt Entry</h5>
							<div class="heading-elements">
								<button type="submit" name="sbm" value="Op_Add" class="btn btn-info" ><i class="icon-add position-left"></i> Ok</button>
								<button type="submit" name="sbm" value="Op_Search" class="btn btn-info" ><i class="icon-search4 position-left"></i> Search</button>
							...
							<div class="col-md-6">
								...
								<fieldset>
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											...
											<label class="form-check-inline">
												<input class="form-check-input" type="radio" id="inlineRadio1" <?php if($query['Terms'] == 'D' ) { echo 'checked'; } ?> name="Terms" value="D" readonly> Daily
											</label>
											<label class="form-check-inline">
												<input class="form-check-input" type="radio" id="inlineRadio2"  <?php if($query['Terms'] == 'W' ) { echo 'checked'; } ?> name="Terms" value="W" readonly> Weekly
											</label>
											<label class="form-check-inline">
												<input class="form-check-input" type="radio" id="inlineRadio3" <?php if($query['Terms'] == 'M' ) { echo 'checked'; } ?> name="Terms" value="M"  readonly> Monthly
											</label>
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control input-xs datepicker-dates" placeholder="Pick a date&hellip;"  name="RCDate" value="<?php 
											if($query['RCDate'] != '') { 
												echo $query['RCDate'];
											}
											else{
								...
								<fieldset>
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											...
											id="PName" name="PName" value="<?php echo $query['PName']; ?>" readonly>
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" placeholder="Enter Loan Date" name="LDate" value="<?php echo $query['LDate']; ?>" readonly>
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" id="LoanAmount" class="form-control" placeholder="Enter Loan Amount" name="Amount" value="<?php echo $query['Amount']; ?>" readonly>
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" id="RecAmount" class="form-control" placeholder="Enter Loan Rec Amount" name="RAmount" value="" readonly>
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" id="BalAmount" class="form-control" placeholder="Enter Loan Balance Amount" name="BAmount" value="<?php echo $query['BAmount']; ?>" readonly>
												<?php 
												if($query['BAmount'] != '' && $query['BAmount'] == 0) {
												   $message = "Acc Was Closed";
												    echo "<script type='text/javascript'>alert('$message');
												    window.location = ('Open_Receipt_Entry') </script>";
												}
												else{
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" id="ArrAmount" class="form-control" placeholder="Enter Arrear Amount" name="AAmount" value="" readonly>
							...
							<div class="col-md-6">
								<fieldset>
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-xs-9">
											<input type="text" placeholder="Particulars" class="form-control" name="Maturity" value="<?php echo $query['Maturity']; ?>" readonly>
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-xs-9">
											...
											<input type="text" id="Due" class="form-control"  name="DAmount" value="<?php echo round($query['Due']); ?>" readonly>
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-xs-9">
											<input type="text" placeholder="Due Date" class="form-control" name="DDate" value="<?php if($query['Terms'] == 'D' ) { echo $query['Monthly']; } if($query['Terms'] == 'W' ) { echo $query['Monthly']; } if($query['Terms'] == 'M' ) { echo $query['Monthly']; } ?>" readonly>
