...
<?php include 'inc/sidebar.php'; ?>
			...
			<div class="content-wrapper">
				...
				<div class="panel panel-flat">
					...
					if($string = 'Months' || 'Weekly' || 'Dailly') { echo $row->AmountM;  echo $row->AmountW; echo $row->AmountD; } ?></td>
								<td><?php $string = $row->Terms;
					if($string = 'Months' || 'Weekly' || 'Dailly') { echo $row->Months;  echo $row->Weekly; echo $row->Dailly; } ?></td>
							</tr>
						<?php endforeach; ?>
						</tbody>
					</table>
