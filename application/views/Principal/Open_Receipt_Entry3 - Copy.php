					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							...
							<div class="heading-elements">
								...
								<button type="submit" name="sbm" value="Op_New" class="btn btn-info" ><i class="icon-new position-left"></i> New</button>
								...
								<a href="<?=site_url('Principal/First_Receipt')?>" class="btn bg-slate" name="View_button" ><i class="icon-archive position-left"></i> First </a>
							</div>
						</div>
								...
								<fieldset>
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											...
											<input type="text" class="form-control"  name="AcNo" value="" >
							...
							<div class="col-md-6">
								<fieldset>
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" placeholder="Enter Loan Amount" name="Pname" value="">
