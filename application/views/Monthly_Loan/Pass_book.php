...
<div class="content-wrapper">
	<div class="col-lg-12">
		...
		<form class="form-horizontal" action="<?=site_url('Monthly_Loan/Pass_Book_Find')?>" method="POST">
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">Monthly Loan - Pass Book</h5>
								...
								<div class="col-lg-9">
									...
									<select name="PName" class="form-control has-warning"> 
										...
										<?php foreach ($result as $row ): ?>
											<option value="<?=$row['AcNo']?>"><?=$row['PName'];?></option> 
										<?php endforeach; ?>
									</select>
