	...
	<div class="content-wrapper">
		...
		<div class="panel panel-flat">
			...
			<div class="panel-heading">
				<h5 class="panel-title">Monthly Loan - <small>Payment View</small> </h5>
				<div class="heading-elements">  
					<div class="heading-btn">
						...
						<a class="btn bg-slate" href="<?=site_url('Monthly_Loan/Payment_Entry')?>"><i class="icon-add position-left"></i> Add New </a>
					</div>
				</div>
			</div>
				...
				<tbody>
					...
					foreach($query->result() as $row)
					{
						...
						<td class="text-center">
							<ul class="icons-list">
								<li class="dropdown">
									<li><a href="<?php echo site_url('Monthly_Loan/Payment_Print/'.$row->id); ?>"><i class=" icon-printer2"></i> Print</a></li>
