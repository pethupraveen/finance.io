...
<body class="navbar-bottom navbar-top">
	...
	<script language="javascript">
		function addNum2()
		{	var val1 = parseInt(document.getElementById("In.Amt").value);
			...
			<div class="col-lg-12">
				...
				<div id="modal_form_inline" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content text-center">
							...
							<form action="<?php echo site_url('Monthly_Loan/Open_Receipt_Search/'); ?>" class="form-inline" 
							method="POST">
				...
				<div id="modal_form_inline2" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content text-center">
							<div class="modal-header"></div>
							<form action="<?php echo site_url('Monthly_Loan/Open_Receipt_New/'); ?>" class="form-inline" 
							method="POST">
								<div class="modal-body">
									<div class="form-group has-feedback">
										<label>AcNo: </label>
				...
				<form class="form-horizontal" action="<?php echo site_url('Monthly_Loan/Add_OP_Receipt/'); ?>" method="POST">
							...
							<div class="col-md-6">
								<fieldset>
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" id="RecAmount" class="form-control" placeholder="Enter Loan Rec Amount" name="RAmount" value="0">
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" id="BalAmount" class="form-control" placeholder="Enter Loan Balance Amount" name="BAmount" value="0">
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" id="payAmount" class="form-control" placeholder="Enter Receipt Loan Amount" name="RLAmount" value="0" onchange="javascript:addNum1();">
							...
							<div class="col-md-6">
								<fieldset>
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" id="In.Amt" class="form-control" placeholder="Enter Interest Amount" name="IAmount" value="<?php echo $query['AIntrest']; ?>">
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" id="In.RAmt" class="form-control" placeholder="Enter Interest Rec Amount" name="IRAmount" value="">
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" id="In.BAmt" class="form-control" placeholder="Enter Interest Balance Amount" name="IBAmount" value="">
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<input type="text" id="R.InAmt" class="form-control" placeholder="Enter Receipt Interest Amount" name="RIAmount" value="0" onchange="javascript:addNum2();">
...
<!--
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-xs-9">
											...
											<input type="text" id="DAmount" class="form-control"  name="DAmount" value="" readonly>
