...
<div class="content-wrapper">
	...
	<div class="row">
		<div class="col-lg-12"> 
			...
			<!-- 2 columns form --> 
<form class="form-horizontal" action="<?=site_url('Monthly_Loan/Update_Op/'.$query2['id']);?>" method="POST"> 
<div class="panel panel-flat"> 
<div class="panel-heading">
	<h5 class="panel-title">Opening Principal Loan s- <mute>Payment Entry</mute></h5> 
	<div class="heading-elements"> 
		<div class="heading-btn"> 
			<a class="btn btn-info" href="<?=site_url('Monthly_Loan/Open_Payment_Entry')?>"><i class="icon-cross2 position-left"></i> Cancel</a> 
			...
			<a class="btn btn-info btn-sm" href="<?=site_url('Monthly_Loan/Open_Payment_Entry')?>"><i class="icon-new position-left"></i>Add New</a> 
		</div> 
	</div> 
</div> 
	...
	<div class="col-md-6">
		<fieldset> 
			<div class="form-group form-group-xs"> <label class="col-lg-3 control-label">Date:</label>
				<div class="col-lg-9">
					<input type="text" class="form-control" placeholder="Enter Current Date" name="MCDate" value="<?php echo $query2['MCDate'];?>" readonly>
			...
			<div class="form-group form-group-xs"> 
				...
				<div class="col-lg-9"> 
					<input type="text" class="form-control" name="AcNo" value="<?php echo $query2['AcNo'];?>" readonly>
				...
				<div class="col-lg-9"> 
					<select name="PName" class="form-control has-warning">
						<?php foreach ($query as $row ): ?> 
							<option value="<?=$row['PName'];?>" <?=set_select('PName', $row['PName']); ?>> 
							<?=$row['PName'];?></option>
						<?php endforeach; ?>
					</select>
					...
					<div class="form-group form-group-xs"> 
						...
						<div class="col-lg-9"> 
							<input type="text" placeholder="Particulars" class="form-control" name="Parti" value="<?php echo $query2['Parti'];?>"> 
					...
					<div class="form-group form-group-xs"> 
						...
						<div class="col-lg-9">
							<input type="text" class="form-control"	placeholder="Enter Amount" id="amount" type="number" min="1" max="1000000" onchange="computeLoan()" name="AmountM" value="<?php echo $query2['AmountM'];?>">
			...
			<div class="col-md-6">
				<fieldset>
					<div class="form-group form-group-xs"> 
						...
						<div class="col-lg-9"> 
							...
							<input id="Docu" type="number"  onchange="computeLoan()" class="form-control" name="Docu" value="<?php echo $query2['Docu'];?>">
					...
					<div class="col-lg-4"> 
						<input class="form-control" name="Intrest" id="interest_rate" type="number" min="0" max="100" value="<?php echo $query2['Intrest'];?>" step=".1" onchange="computeLoan()">
						<?php echo form_error('Intrest', '<div class="text-danger">', '</div>'); ?>
					</div> 
					<div class="col-lg-4"> 

						<input type="text" class="form-control" id="interest" placeholder="Intrest Amount" name="IAmount" value="<?php echo $query2['IAmount']; ?>" >
				...
				<div class="form-group form-group-xs">
					...
					<div class="col-lg-9"> 
						<input class="form-control" placeholder="Enter Advance Intrest Amount" name="AIntrest" id="Ainterest" type="number" value="<?php echo $query2['AIntrest'];?>" onchange="computeLoan()"> 
				...
				<div class="form-group form-group-xs">
					...
					<div class="col-lg-9"> 
						<input type="text" placeholder="Documnet Details" class="form-control" name="DocDetail" value="<?php echo $query2['DocDetail'];?>"> 
