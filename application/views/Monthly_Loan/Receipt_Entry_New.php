			...
			<div class="col-lg-12">
				...
				<div id="modal_form_inline" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content text-center">
							...
							<form action="<?php echo site_url('Monthly_Loan/Receipt_Search/'); ?>" class="form-inline" 
							method="POST">
				...
				<div id="modal_form_inline2" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content text-center">
							<div class="modal-header"></div>
							<form action="<?php echo site_url('Monthly_Loan/Receipt_New/'); ?>" class="form-inline" 
							method="POST">
								<div class="modal-body">
									<div class="form-group has-feedback">
										<label>AcNo: </label>
				...
				<form class="form-horizontal" action="<?php echo site_url('Monthly_Loan/Add_P_Receipt/'); ?>" method="POST">
