						...
						<fieldset>
							...
							<div class="form-group form-group-xs">
								...
								<div class="col-lg-9">
									...
									<input type="text" class="form-control datepicker-dates" placeholder="Pick a date&hellip;" id="enddate" name="date1" value="<?php 
									if($query['DDate'] == '')
									{
									echo date('d/m/Y');	
									}
							...
							<div class="form-group form-group-xs">
								...
								<div class="col-lg-9">
									...
									<input type="text" class="form-control" id="AcNo" name="P_AcNo" value="<?php echo $query['AcNo']; ?>" >
						...
						<fieldset>
							...
							<div class="form-group form-group-xs">
								...
								<div class="col-lg-9">
									...
									value="<?php if($query['pcode'] == $query['pcode'] ) { echo $query['PName']; } ?>" readonly>
							...
							<div class="form-group form-group-xs">
								...
								<div class="col-lg-9">
									<input type="text" id="p" class="form-control add" placeholder="Enter Loan Amount" name="DAmt" value="<?php echo $query['Amount']; ?>" readonly>
							...
							<div class="form-group form-group-xs">
								...
								<div class="col-lg-9">
									<input type="text" id="DPAmt" class="form-control add2" placeholder="Enter Loan Rec Amount" name="DPAmt" value="<?php echo $query['DPAmt']; ?>">
							...
							<div class="form-group form-group-xs">
								...
								<div class="col-lg-9">
									<input type="text" id="DBAmt" class="form-control total" placeholder="Enter Loan Balance Amount" name="DBAmt" value="
									<?php 
									if($query['DBAmt'] != 0)
									{
					...
					<div class="col-md-6">
						<fieldset>
							<div class="form-group form-group-xs">
								...
								<div class="col-lg-9">
									<input type="hidden" id="in" class="form-control" value="<?php echo $query['Interest']; ?>">
									<input type="hidden" id="duration" name="days" class="form-control">
									
									<input type="text" id="res" class="form-control" name="IAmt" value="<?php echo $query['IAmt']; ?>">
							...
							<div class="form-group form-group-xs">
								...
								<div class="col-lg-9">
									<input type="text" id="IPAmt" class="form-control" placeholder="Enter Interest Rec Amount" name="IPAmt" value="<?php echo $query['IPAmt']; ?>">
							...
							<div class="form-group form-group-xs">
								...
								<div class="col-lg-9">
									<input type="text" class="form-control productTextInput" id="balance" name="IBAmt" value="
									<?php echo $query['IBAmt']; ?>">
