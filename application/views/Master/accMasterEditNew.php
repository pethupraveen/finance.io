<div class="content-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<form class="form-horizontal" action="<?php echo site_url('Master/update_dataNew/'.$r->Code); ?>" method="POST">
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<label class="form-check-inline">
												<input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="TieUp" <?php if($r->TieUp_Owner == 'TieUp' ) { echo 'checked'; } ?> name="TieUp_Owner"> TieUp
											</label>
											<label class="form-check-inline">
												<input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="Owner" name="TieUp_Owner" <?php if($r->TieUp_Owner == 'Owner' ) { echo 'checked'; } ?>>   Owner
											</label>
								...
								<fieldset>
									...
									<div class="form-group form-group-xs">
										...
										<div class="col-lg-9">
											<div class="row">
												<div class="col-md-6">
													<input type="tel" placeholder="PhoneOff" class="form-control mb-15" name="PhoneOff" value="<?php echo $r->PhoneOff; ?>" >
													<?php echo form_error('PhoneOff', '<div class="text-danger">', '</div>'); ?>
												</div>

												<div class="col-md-6">

													<input type="tel" placeholder="PhoneRes" class="form-control" name="PhoneRes" value="<?php echo $r->PhoneRes; ?>">
										...
										<div class="col-lg-9">
											<div class="row">
												<div class="col-md-6">
													...
													<input type="text" placeholder="PinCode" class="form-control" name="PinCode" value="<?php echo $r->PinCode; ?>">
