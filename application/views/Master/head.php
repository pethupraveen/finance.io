...
<!-- Theme JS files -->
	...
	<script type="text/javascript" src="<?=site_url('assets') ?>/js/pages/datatables_basic1.js"></script>
	<!-- /theme JS files 
...
<body class="navbar-bottom navbar-top">
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-header">
			<a class="navbar-brand" href="<?=site_url('Master') ?>"><img src="<?=site_url('assets') ?>/images/logo_light.png" alt=""></a>
