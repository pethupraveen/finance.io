...
<form class="form-horizontal" action="<?=site_url('Master/Add')?>" method="POST">
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">Acconut Master Entrys</h5>
		<div class="heading-elements">
			<div class="heading-btn">
				...
				<a class="btn btn-info" href="<?=site_url('Master/Master_Delete')?>"><i class="icon-bin2 position-left"></i> Delete</a>
			</div>
			...
			<div class="col-md-6">
				<fieldset>
					...
					<div class="form-group form-group-xs">
						...
						<div class="col-lg-9">
							<input type="text" class="form-control" placeholder="Enter account name" name="Name" value="<?php echo set_value('Name')?>">
					...
					<div class="form-group form-group-xs">
						...
						<div class="col-lg-9">
							<label class="form-check-inline">
								<input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="TieUp" name="TieUp_Owner" > TieUp
							</label>
							<label class="form-check-inline">
								<input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="Owner" name="TieUp_Owner"> Owner
							</label>
					...
					<div class="form-group form-group-xs">
						...
						<div class="col-lg-9">
							<input type="text" placeholder="Number Only" class="form-control" name="OpBal" value="<?php echo set_value('OpBal')?>">
