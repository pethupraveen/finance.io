						...
						<fieldset>
							<legend class="text-semibold">
								...
								<div class="form-group ">
									...
									<div class="col-lg-9">
										<input type="text" class="form-control" placeholder="Enter Party Name" value="<?php echo set_value('PName')?>" name="PName" required>
								...
								<div class="form-group form-group-xs">
									...
									<div class="col-lg-9">
										<div class="row">
											<div class="col-md-6">
												<input type="tel" placeholder="Phone" class="form-control mb-15" name="Phone" maxlength="10"  value="<?php echo set_value('Phone')?>" required>
