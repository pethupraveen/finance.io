...
<head>
	...
	<!-- /theme JS files <script type="text/javascript" src="<?=site_url('assets') ?>/js/pages/dashboard.js"></script> -->
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						...
						<li><a href="dashboard/logout"><i class="icon-switch2"></i> Logout</a></li>
					</ul>
				</li>
			</ul>
		</div>
